export const workExp = [
  {
    ...
    date: "From 07/2021 - 07/2022",
    duties: [
      "revamped and improved client's current system",
      "develop different projects basaed on client requirements",
      "Participated in client/users meeting and develop new features based on their needs",
    ],
    skills: ["react", "laravel", "js", "redux", "css"],
    companyImg: "/egusi.png",
  },
  {
    company: "Siemens Advanta HK",
    position: "Software Developer (Subcontract)",
    date: "From 11/2021 - 07/2022",
    duties: [
      "Maintenance and support of client’s projects",
      "resolving program bugs, refractoring existing code/components",
      "Participated in migrating local server to AWS Cloud Service",
      "Developed a proactive call system using Google App Script which could assign the cases to related engineers",
    ],
    skills: [
      "aws",
      "k8s",
...
export const projects = [
  ...
  },
  {
    ...
    heading: "E-commerce Web using NextJS",
